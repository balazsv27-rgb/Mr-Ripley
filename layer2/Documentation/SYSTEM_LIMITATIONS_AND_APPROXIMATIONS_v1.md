...
> **Canonical interim verification status:** use `DOCUMENTATION_VERIFICATION_MATRIX_v1.md` as the classification layer for the current v1 documentation set, and `SYSTEM_TECHNICAL_HANDBOOK_v1.md` §14 ("Verification Status") for open repo-hygiene / doc-sync tracking.
