...
The following implementation components are **planned only**:
...
- Supervisor Engine
- Decision Engine
- DecisionPacket generation / emission logic
- Execution Layer

Important clarification:

- **DecisionPacket schema v0 is already defined** as the current governed action contract.
- **What is not yet built** is the Layer 3 implementation that generates and emits DecisionPackets.
